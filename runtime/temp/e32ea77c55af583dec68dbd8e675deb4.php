<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:77:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\User\index.html";i:1566204511;s:78:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\Public\base.html";i:1563256854;}*/ ?>
<!DOCTYPE html>
<html lang="en">
        ...
        <table id="demo-dt-addrow" class="table table-striped table-bordered" cellspacing="0" width="100%">
            ...
            <tbody class="tab">
               <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                <tr>
                    <input type="hidden" class="tab-money" id="money<?php echo $vo['id']; ?>" value="<?php echo $vo['money']; ?>">
                    <input type="hidden" class="tab-nomoney" id="noMoney<?php echo $vo['id']; ?>" value="<?php echo $vo['noMoney']; ?>">
                    <input type="hidden" class="tab-level" id="level<?php echo $vo['id']; ?>" value="<?php echo $vo['level']; ?>">
                    ...
                    <td class="sum" id="advancedepositincome<?php echo $vo['id']; ?>"><?php echo $vo['advance_deposit']; ?></td>
                    <td><?php echo date('Y-m-d H:i:s',$vo['create_time']); ?></td>
                    <td>
                        <a href="/Admin/User/show/<?php echo $vo['id']; ?>" class="btn btn-xs btn-rounded btn-mint">查看</a>
                        <a href="/Admin/User/update/<?php echo $vo['id']; ?>" class="btn btn-xs btn-rounded btn-warning">修改</a>
                    	<a href="/Admin/User/update_pay/<?php echo $vo['id']; ?>" class="btn btn-xs btn-rounded btn-mint">重置支付密码</a>
