<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:82:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\User\update_pwd.html";i:1563256854;s:78:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\Public\base.html";i:1563256854;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<div class="panel">
  ...
  <div class="panel-heading">
    ...
    <h3 class="panel-title">重置登陆密码</h3>
      ...
      <div class="tab-content">
        ...
        <div id="demo-tabs-box-1" class="tab-pane fade in active">
          <div class="form-group has-feedback">
            ...
            <div class="col-lg-7">
              <input type="password" class="form-control" name="password"  placeholder="登录密码" data-bv-field="password">
         ...
         <div id="demo-tabs-box-1" class="tab-pane fade in active">
          <div class="form-group has-feedback">
            ...
            <div class="col-lg-7">
              <input type="password" class="form-control" name="passwords" placeholder="确认登录密码" data-bv-field="password">
              <i class="form-control-feedback" data-bv-icon-for="name" style="display: none;"></i>
            </div>
          </div>
        </div>
...
<script>
  $(function(){
      $('#UpdateSubmit').click(function(){
        ...
        $.ajax({
          type: 'POST',
          url:'/Admin/User/Do_Update_pwd?id=<?php echo $update['id']; ?>',
          data:formData,
          contentType: false,
          processData: false,
