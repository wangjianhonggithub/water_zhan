<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:89:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\empty_bucket\user_list.html";i:1568706599;s:78:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\Public\base.html";i:1563256854;}*/ ?>
<!DOCTYPE html>
<html lang="en">
            ...
            <tbody>
               <?php if(is_array($list['data']) || $list['data'] instanceof \think\Collection || $list['data'] instanceof \think\Paginator): if( count($list['data'])==0 ) : echo "" ;else: foreach($list['data'] as $key=>$vo): ?>
                <tr>
                    ...
                    <td><?php echo $vo['belong_area']; ?></td>
                    <td><?php echo $vo['username']; ?></td>
                    <td><?php echo $vo['profit']; ?></td>
                    <td><?php echo $vo['expenditure']; ?></td>
                    <td><?php echo $vo['net_profit']; ?></td>
                    <td>
                    <!-- 	<a href="/Admin/Bucket/substitutionAction?id=<?php echo $vo['id']; ?>" class="btn btn-xs btn-rounded btn-success">操作</a> -->
                         <!--<a href="/Admin/Branch_store/edit?id=<?php echo $vo['id']; ?>"  class="btn btn-xs btn-rounded btn-mint">修改</a>-->
                        <!--<a href="/Admin/Branch_store/distribution?id=<?php echo $vo['id']; ?>&old_admin_id=<?php echo $vo['admin_id']; ?>"  class="btn btn-xs btn-rounded btn-mint">分配店长</a>-->
                        <!--<a href="/Admin/Branch_store/DistributionArea?id=<?php echo $vo['id']; ?>"  class="btn btn-xs btn-rounded btn-mint">分配片区</a>-->
                        <!--<a href="/Admin/StoreGoodsInfo?store_id=<?php echo $vo['id']; ?>"  class="btn btn-xs btn-rounded btn-mint">商品管理</a>-->
                        <!--<a href="<?php echo url('EmptyBucket/assignBucket',array('id'=>$vo['id'],'username'=>$vo['name'])); ?>" class="btn btn-xs btn-rounded btn-mint">空桶管理</a>-->

                        <a href="/Admin/Branch_store/management?id=<?php echo $vo['id']; ?>" class="btn btn-xs btn-rounded btn-mint">店面管理</a>
