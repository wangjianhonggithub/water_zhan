<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:81:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\User\info_show.html";i:1563256856;s:78:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\Public\base.html";i:1563256854;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<div class="panel">
  ...
  <div class="panel-heading">
    ...
    <h3 class="panel-title">商家信息展示</h3>
  </div>
  ...
  <form id="demo-bv-errorcnt" class="form-horizontal bv-form" action="" method="POST" novalidate="novalidate">
    ...
    <input type="hidden" class="form-control" name="uid" value="<?php echo $uid; ?>" placeholder="商家ID" data-bv-field="uid">
      ...
      <div class="tab-content">
        ...
        <div id="demo-tabs-box-1" class="tab-pane fade in active">
          ...
          <div class="form-group has-feedback">
            ...
            <div class="col-lg-4">
              <input type="text" class="form-control" disabled name="title" value="<?php echo $title; ?>" placeholder="商品名称" data-bv-field="name">
              <i class="form-control-feedback" data-bv-icon-for="name" style="display: none;"></i>
            </div>
          </div>
          <div class="form-group has-feedback">
            <label class="col-lg-3 control-label">商店名称</label>
            <div class="col-lg-4">
              <input type="text" class="form-control" name="title" value="<?php echo $update['title']; ?>" placeholder="商店名称" data-bv-field="name">
              <i class="form-control-feedback" data-bv-icon-for="name" style="display: none;"></i>
            </div>
          </div>
           <div class="form-group has-feedback">
            ...
            <div class="col-lg-4">
              <input type="text" class="form-control" name="mobile" value="<?php echo $update['mobile']; ?>" placeholder="联系方式" data-bv-field="name">
              <i class="form-control-feedback" data-bv-icon-for="name" style="display: none;"></i>
            </div>
          </div>
           <div class="form-group has-feedback">
            ...
            <div class="col-lg-4">
              <input type="text" class="form-control" name="address" value="<?php echo $update['address']; ?>" placeholder="地址" data-bv-field="name">
              <i class="form-control-feedback" data-bv-icon-for="name" style="display: none;"></i>
            </div>
          </div>
          ...
          <div class="form-group has-feedback">
            ...
            <div class="col-lg-4">
              <img src="<?php echo $update['pic']; ?>" alt="" style="width: 150px;height: 120px;">
            </div>
          </div>
          <div class="form-group has-feedback">
            <label class="col-lg-3 control-label">上传封面</label>
            <div class="col-lg-4">
              <input type="file" class="form-control" name="pic" placeholder="商品单价" data-bv-field="name">
              <i class="form-control-feedback" data-bv-icon-for="name" style="display: none;"></i>
            </div>
          </div>

         <div class="form-group has-feedback">
            <label class="col-lg-3 control-label">商店详情</label>
            <div class="col-lg-4">
              <script id="detail" name="detail" type="text/plain"><?php echo $update['detail']; ?></script>
            </div>
        </div>
        ...
        <div class="form-group has-feedback">
            ...
            <div class="col-lg-7">
              <input type="radio" name="status" value="1" <?php if($update): ?><?php echo $update['status'] == 1 ? "checked" : ''; else: ?><?php echo $status==1?"checked" : ''; endif; ?>> <label>显示</label>

              <input type="radio" name="status" value="0" <?php if($update): ?><?php echo $update['status'] == 0 ? "checked" : ''; else: ?><?php echo $status==0?"checked" : ''; endif; ?>> <label>隐藏</label>
...
<script>
  ...
  $(function(){
      ...
      $('#CreateSubmit').click(function(){
        ...
        $.ajax({
          type: 'POST',
          url:'/Admin/User/update_info_show?id=<?php echo $update['id']; ?>',
          data:formData,
          contentType: false,
          processData: false,
