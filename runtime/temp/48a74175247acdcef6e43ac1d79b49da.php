<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:78:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\Help\update.html";i:1563256850;s:78:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\Public\base.html";i:1563256854;}*/ ?>
<!DOCTYPE html>
<html lang="en">
      ...
      <div class="tab-content">
        ...
        <div id="demo-tabs-box-1" class="tab-pane fade in active">
	        <div class="form-group has-feedback">
	            ...
	            <div class="col-lg-4">
		            <input type="text" class="form-control" name="problem" value="<?php echo $update['problem']; ?>" placeholder="常见问题" data-bv-field="name">
        ...
        <div id="demo-tabs-box-1" class="tab-pane fade in active">
          <div class="form-group has-feedback">
            ...
            <div class="col-lg-7">
              <textarea name="answer" id="reviewww" style="height:270px; width:700px;" ><?php echo $update['answer']; ?></textarea>
              <i class="form-control-feedback" data-bv-icon-for="name" style="display: none;"></i>
            </div>
          </div>
        </div>
<!-- 
	        <div class="form-group has-feedback">
	            ...
	            <div class="col-lg-4">
	                <script id="answer" name="answer" type="text/plain"><?php echo $update['answer']; ?></script>
	            </div>
	        </div> -->
        </div>
       </div>
...
<script>
    ...
    $(function(){
      $('#CreateSubmit').click(function(){
        ...
        $.ajax({
          type: 'POST',
          url:'/Admin/Help/DoUpdate?id=<?php echo $update['id']; ?>',
          data:{
              problem:problem,
              answer:answer,
          },
