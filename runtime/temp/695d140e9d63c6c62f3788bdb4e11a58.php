<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:83:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\PutForward\index.html";i:1563256854;s:78:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\Public\base.html";i:1563256854;}*/ ?>
<!DOCTYPE html>
<html lang="en">
            ...
            <tbody>
               <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                <tr>
                    ...
                    <td style="color:red"><?php echo $vo['status'] == 0 ? "待处理" : "已处理"; ?></td>
                    <td style="color:red"><?php echo $vo['putStatus'] == 0 ? "待处理" : ($vo['putStatus'] == 1 ? "通过" : "驳回"); ?></td>
                    <td><?php echo date('Y-m-d H:i:s',$vo['createTime']); ?></td>
                    <td>
                    	<a href="/Admin/PutForward/action/<?php echo $vo['id']; ?>" class="btn btn-xs btn-rounded btn-mint">处理</a>
                    </td>
                </tr>
