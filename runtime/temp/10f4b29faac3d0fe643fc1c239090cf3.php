<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:84:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\PutForward\action.html";i:1563256854;s:78:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\Public\base.html";i:1563256854;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="panel-body">
      <div class="tab-content">
        ...
        <div class="form-group has-feedback">
            ...
            <div class="col-lg-4">
              <input type="text" class="form-control" disabled  name="nickname" datavalue="<?php echo $update['nickname']; ?>" placeholder="昵称" data-bv-field="name">
          ...
          <div class="form-group has-feedback">
            ...
            <div class="col-lg-4">
              <input type="text" class="form-control" disabled  name="username" value="<?php echo $update['username']; ?>" placeholder="用户名称" data-bv-field="name">
              <i class="form-control-feedback" data-bv-icon-for="name" style="display: none;"></i>
            </div>
          </div>
          <div class="form-group has-feedback">
            ...
            <div class="col-lg-4">
              <input type="text" class="form-control"  disabled name="mobile" value="<?php echo $update['mobile']; ?>" placeholder="手机号码" data-bv-field="name">
              <i class="form-control-feedback" data-bv-icon-for="name" style="display: none;"></i>
            </div>
          </div>
          <div class="form-group has-feedback">
            ...
            <div class="col-lg-4">
              <input type="text" class="form-control"  disabled name="money" value="<?php echo $update['money']; ?>" placeholder="提现金额" data-bv-field="name">
              <i class="form-control-feedback" data-bv-icon-for="name" style="display: none;"></i>
            </div>
          </div>
          ...
          <div class="form-group has-feedback">
            ...
            <div class="col-lg-4">
              <input type="text" class="form-control"  disabled name="bank" value="<?php echo $update['bank']; ?>" placeholder="开户银行" data-bv-field="name">
              <i class="form-control-feedback" data-bv-icon-for="name" style="display: none;"></i>
            </div>
          </div>
          ...
          <div class="form-group has-feedback">
            ...
            <div class="col-lg-4">
              <input type="text" class="form-control"  disabled name="cardNo" value="<?php echo $update['cardNo']; ?>" placeholder="银行账户" data-bv-field="name">
              <i class="form-control-feedback" data-bv-icon-for="name" style="display: none;"></i>
            </div>
          </div>
           ...
           <div class="form-group has-feedback">
            ...
            <div class="col-lg-4">
              <input type="text" class="form-control"  disabled name="cusername" value="<?php echo $update['cusername']; ?>" placeholder="持卡人" data-bv-field="name">
              <i class="form-control-feedback" data-bv-icon-for="name" style="display: none;"></i>
            </div>
          </div>
...
<script>
  $(function(){
       ...
       console.log(putStatus)
        $.ajax({
          type: 'POST',
          url:'/Admin/Putforward/DoAction?id=<?php echo $update['id']; ?>&putStatus=1',
          data:{},
          contentType: false,
          processData: false,
       ...
       console.log(putStatus)
        $.ajax({
          type: 'POST',
          url:'/Admin/Putforward/DoAction?id=<?php echo $update['id']; ?>&putStatus=2',
          data:{},
          contentType: false,
          processData: false,
          success: function(data){
