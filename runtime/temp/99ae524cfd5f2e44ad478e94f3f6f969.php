<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:83:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\BranchStore\edit.html";i:1566289181;s:78:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\Public\base.html";i:1563256854;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  ...
  <form id="demo-bv-errorcnt" class="form-horizontal bv-form" action="" method="POST" enctype="multipart/form-data" novalidate="novalidate">
    ...
    <div class="panel-body">
      <div class="tab-content">
        ...
        <!--===================================================-->
        <input type="hidden" name="store_id" value="<?php echo $data['id']; ?>">
        <div id="demo-tabs-box-1" class="tab-pane fade in active">
          <div class="form-group has-feedback">
            <label class="col-lg-3 control-label">所属区域</label>
            <div class="col-lg-7">
              <input type="text" class="form-control" name="belong_area" value="<?php echo $data['belong_area']; ?>" placeholder="北京市-房山区-长阳镇" data-bv-field="name">
        ...
        <div id="demo-tabs-box-1" class="tab-pane fade in active">
          <div class="form-group has-feedback">
            ...
            <div class="col-lg-7">
              <input type="text" class="form-control" name="name" value="<?php echo $data['name']; ?>" placeholder="分店名称" data-bv-field="name">
              <i class="form-control-feedback" data-bv-icon-for="name" style="display: none;"></i>
            </div>
          </div>
        </div>
          <div id="demo-tabs-box-1" class="tab-pane fade in active">
            <div class="form-group has-feedback">
              ...
              <div class="col-lg-7">
                <textarea name="intro" style="height:270px; width:700px;" ><?php echo $data['intro']; ?></textarea>
                <i class="form-control-feedback" data-bv-icon-for="name" style="display: none;"></i>
              </div>
            </div>
          </div>
          <div id="demo-tabs-box-1" class="tab-pane fade in active">
            <div class="form-group has-feedback">
              ...
              <div class="col-lg-7">
                <input type="text" class="form-control" name="rent_cost" value="<?php echo $data['rent_cost']; ?>" placeholder="店面房租" data-bv-field="name">
                <i class="form-control-feedback" data-bv-icon-for="name" style="display: none;"></i>
              </div>
            </div>
