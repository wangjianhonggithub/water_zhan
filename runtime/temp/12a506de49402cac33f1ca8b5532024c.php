<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:83:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\User\Shang_index.html";i:1563256858;s:78:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\Public\base.html";i:1563256854;}*/ ?>
<!DOCTYPE html>
<html lang="en">
            ...
            <tbody>
               <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                <tr>
                    ...
                    <td style="color:red"><?php echo $vo['identity']; ?></td>
                    <td><?php echo $vo['username']; ?></td>
                    <td><?php echo $vo['nickname']; ?></td>
                    <td><img src="<?php echo $vo['photo']; ?>" alt="" style="width:80px;height: 80px;"></td>
                    <td><?php echo $vo['mobile']; ?></td>
                    <td><?php echo $vo['money']; ?></td>
                    <td><?php echo $vo['noMoney']; ?></td>
                    <td style="color:red"><?php echo $vo['status'] == 0 ? "冻结" : "正常"; ?></td>
                    <td><?php echo date('Y-m-d H:i:s',$vo['create_time']); ?></td>
                    <td><?php echo date('Y-m-d H:i:s',$vo['update_time']); ?></td>
                    <td>
                        <a href="/Admin/User/shang_show/<?php echo $vo['id']; ?>" class="btn btn-xs btn-rounded btn-mint">查看</a>
                        <a href="/Admin/User/update/<?php echo $vo['id']; ?>" class="btn btn-xs btn-rounded btn-warning">修改</a>
                        <a href="javascript:;" data-id="<?php echo $vo['id']; ?>" class="btn btn-xs btn-rounded btn-mint getWchatQrcode">生成商家二维码</a>
                        <a href="/Admin/User/profit/<?php echo $vo['id']; ?>" class="btn btn-xs btn-rounded btn-mint">收益记录</a>
                        <a href="/Admin/User/info_show/<?php echo $vo['id']; ?>" class="btn btn-xs btn-rounded btn-warning">商家展示信息</a>
                        <a href="javascript:;" data-id="<?php echo $vo['id']; ?>" data-flag="<?php echo $vo['flag']; ?>" class="btn btn-xs setFlag btn-rounded Delete btn-danger"><?php echo $vo['flag']==1?'取消首页展示' : '首页展示'; ?></a>
                        <a href="/Admin/User/update_pwd/<?php echo $vo['id']; ?>" class="btn btn-xs btn-rounded btn-mint">重置登陆密码</a>
                        <a href="javascript:;" data-id="<?php echo $vo['id']; ?>" data-status="<?php echo $vo['status']; ?>" class="btn btn-xs DeleteSubmit btn-rounded Delete btn-danger">冻结/解冻</a>
