<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:77:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\Search\add.html";i:1563256854;s:78:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\Public\base.html";i:1563256854;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="panel-body">
      <div class="tab-content">
        ...
        <div class="form-group has-feedback">
            ...
            <div class="col-lg-4">
              <input type="number" class="form-control" name="order" placeholder="排序" data-bv-field="name">
              <i class="form-control-feedback" data-bv-icon-for="name" style="display: none;"></i>
            </div>
        </div>
       </div>
