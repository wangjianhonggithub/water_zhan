<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:85:"E:\PHPTutorial\WWW\jjzs\public/../application/admin\view\StoreStock\stock_updata.html";i:1564045319;s:73:"E:\PHPTutorial\WWW\jjzs\public/../application/admin\view\Public\base.html";i:1563256854;}*/ ?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="tab-content">
                <div id="demo-tabs-box-1" class="tab-pane fade in active">
                    <div class="form-group has-feedback">
                        ...
                        <div class="col-lg-4">
                            <input type="hidden" class="goodsId" value="<?php echo $rs['goods_id']; ?>">
                            <input type="hidden" class="oldnum" value="<?php echo $rs['stock']; ?>">
                            <input type="text" class="form-control" name="unused" placeholder="原库存：<?php echo $rs['stock']; ?>" data-bv-field="name">
...
<script>
    ...
    $(function(){
        $('#CreateSubmit').click(function(){
            var afterNum = $(".form-control").val()*1;
            var oldNum = $(".oldnum").val()*1;
            var totalNum = afterNum+oldNum;
            var goodsId = $(".goodsId").val();
            $.ajax({
                type: 'POST',
                url: '/Admin/StoreStockUpdata',
                data: {
                    goods_id:goodsId,//产品id
                    oldNum:oldNum,//原库存
                    afterNum:afterNum,//新增加库存
                    totalNum:totalNum//增加后总共
                },
