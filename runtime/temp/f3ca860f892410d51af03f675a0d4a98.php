<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:87:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\Administrator\update.html";i:1565172469;s:78:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\Public\base.html";i:1563256854;}*/ ?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div id="demo-tabs-box-1" class="tab-pane fade in active">
          ...
          <div class="form-group has-feedback">
            ...
            <div class="col-lg-7">
              ...
              <input type="email" class="form-control" name="salary" value="<?php echo $update['salary']; ?>" placeholder="基本工资" data-bv-field="email">
              <i class="form-control-feedback" data-bv-icon-for="email" style="display: none;"></i>
            </div>
          </div>
          <div class="form-group has-feedback">
            ...
            <div class="col-lg-7">
              ...
              <input type="email" class="form-control" name="royalty" value="<?php echo $update['royalty']; ?>" placeholder="店主工资提成" data-bv-field="email">
              <i class="form-control-feedback" data-bv-icon-for="email" style="display: none;"></i>
            </div>
          </div>
          <div class="form-group has-feedback">
