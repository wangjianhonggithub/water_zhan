<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:82:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\BranchStore\add.html";i:1569547822;s:78:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\Public\base.html";i:1563256854;}*/ ?>
<!DOCTYPE html>
<html lang="en">
            ...
            <!--<div class="col-md-9">-->
              <!--<div class="checkbox">-->
                <!--<div class="col-lg-7">-->
                  ...
                  <!--<li style="list-style-type:decimal"><input name="region" value="<?php echo $vo['id']; ?>" type="checkbox" ><span><?php echo $vo['title']; ?></span></li>-->
