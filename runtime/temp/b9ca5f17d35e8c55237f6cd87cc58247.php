<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:89:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\Statistics\money_count.html";i:1568275749;s:78:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\Public\base.html";i:1563256854;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<div class="panel">
    ...
    <div class="panel-body">
        <table id="demo-dt-addrow" class="table table-striped table-bordered" cellspacing="0" width="100%">
            <thead>
            <tr>
                <th style="text-align: center">桶押金收益</th>
                <th style="text-align: center">会员卡金收益</th>
                <th style="text-align: center">不可提现金额收益</th>
                <th style="text-align: center">余额</th>
                <th style="text-align: center">预存款收益</th>
            </tr>
            </thead>
            <tbody>
            <tr>
                <td style="text-align: center"><?php echo $buckets; ?></td>
                <td style="text-align: center"><?php echo $cardmoney; ?></td>
                <td style="text-align: center"><?php echo $nomoney; ?></td>
                <td style="text-align: center"><?php echo $money; ?></td>
                <td style="text-align: center"><?php echo $yucun; ?></td>
            </tr>
        </table>
        <div>
            <tr class="content">
