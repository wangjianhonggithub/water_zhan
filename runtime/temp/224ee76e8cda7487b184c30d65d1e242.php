<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:80:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\Region\update.html";i:1563256854;s:78:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\Public\base.html";i:1563256854;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="panel-body">
      <div class="tab-content">
        ...
        <div class="form-group has-feedback">
            ...
            <div class="col-lg-7">
              <input type="text" class="form-control" name="title" placeholder="片区名称" value="<?php echo $update['title']; ?>" data-bv-field="title">
                ...
                <div class="checkbox">
                   <div class="col-lg-7">
                    <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                      <li style="list-style-type:decimal"><input name="address" <?php if(in_array($vo['id'],explode(',',$update['address']))){ echo 'checked';} ?> value="<?php echo $vo['id']; ?>" type="checkbox" ><span><?php echo $vo['title']; ?></span></li>
...
<script>
  $(function(){
      $('#UpdateSubmit').click(function(){
        ...
        $.ajax({
          type: 'POST',
          url:'/Admin/Region/DoUpdate?id=<?php echo $update['id']; ?>',
          data: {
