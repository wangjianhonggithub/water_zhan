<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:86:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\Bucket\substitution.html";i:1563256846;s:78:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\Public\base.html";i:1563256854;}*/ ?>
<!DOCTYPE html>
<html lang="en">
            ...
            <tbody>
               <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                <tr>
                    ...
                    <td style="color:red"><?php echo $vo['status'] == 0 ? "待审核" : "已通过"; ?></td>
                    <td style="color:red"><?php echo $vo['type'] == 1 ? "月租" : "年租"; ?></td>
                    <td>
                        <!-- <button type="button" class="btn btn-mint subOrder" data-id="<?php echo $vo['id']; ?>">操作</button> -->
