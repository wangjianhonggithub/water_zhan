<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:86:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\empty_bucket\fenpei.html";i:1565162595;s:78:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\Public\base.html";i:1563256854;}*/ ?>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="checkbox">
                   <div class="col-lg-7">
                    <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                      <li style="list-style-type:decimal"><input name="admin_id" <?php if($old_admin_id == $vo['id']){ echo 'checked';} ?>  value="<?php echo $vo['id']; ?>" type="radio" ><span><?php echo $vo['username']; ?></span></li>
