<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:83:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\Order\shouAction.html";i:1563256852;s:78:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\Public\base.html";i:1563256854;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<?php if($info['deliverType'] == 1): ?>
        ...
        <div class="form-group has-feedback">
          ...
          <div class="col-lg-4">
            <textarea name="" style="width:540px; height:140px;" ><?php echo $info['showText']; ?></textarea>
            <i class="form-control-feedback" data-bv-icon-for="name" style="display: none;"></i>
          </div>
        </div>
        <?php if($info['orderShowStatus'] == 1): ?>
            <div class="panel-footer clearfix">
              <div class="col-lg-7 col-lg-offset-3">
                <button type="button" class="btn btn-mint subOrder" data-id="<?php echo $info['id']; ?>" data-type="1" >处理</button>                
              </div>
            </div>
