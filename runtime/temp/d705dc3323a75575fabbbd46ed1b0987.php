<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:82:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\Category\update.html";i:1563256848;s:78:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\Public\base.html";i:1563256854;}*/ ?>
<!DOCTYPE html>
<html lang="en">
      ...
      <div class="tab-content">
        ...
        <div id="demo-tabs-box-1" class="tab-pane fade in active">
          <div class="form-group has-feedback">
            ...
            <div class="col-lg-7">
              <input type="text" class="form-control" name="name" value="<?php echo $update['name']; ?>" placeholder="分类名称" data-bv-field="name">
              <i class="form-control-feedback" data-bv-icon-for="name" style="display: none;"></i>
            </div>
          </div>
          <!-- <div class="form-group has-feedback">
            <label class="col-lg-3 control-label">分类简述</label>
            <div class="col-lg-7">
              <input type="text" class="form-control" name="description" value="<?php echo $update['description']; ?>" placeholder="分类简述" data-bv-field="name">
              <i class="form-control-feedback" data-bv-icon-for="name" style="display: none;"></i>
            </div>
          </div>
          <div class="form-group has-feedback">
            ...
            <div class="col-lg-7">
              <img src="<?php echo $update['img']; ?>" alt="" style="width: 150px;height: 120px;">
            </div>
          </div>
          <div class="form-group has-feedback">
            <label class="col-lg-3 control-label">分类展示图</label>
            <div class="col-lg-7">
              <input type="file" class="form-control" name="img" placeholder="分类简述" data-bv-field="name">
            </div>
          </div>
          <div class="form-group has-feedback">
            <label class="col-lg-3 control-label">温馨提示</label>
            <div class="col-lg-7">
              <input type="text" class="form-control" name="prompt" value="<?php echo $update['prompt']; ?>" placeholder="温馨提示" data-bv-field="name">
            </div>
          </div> -->
        </div>
       </div>
...
<script>
  $(function(){
      $('#UpdateSubmit').click(function(){
        ...
        $.ajax({
          type: 'POST',
          url:'/Admin/Category/DoUpdate?id=<?php echo $update['id']; ?>',
          data:formData,
          contentType: false,
          processData: false,
