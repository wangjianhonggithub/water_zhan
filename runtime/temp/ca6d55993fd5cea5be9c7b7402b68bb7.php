<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:83:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\User\Song_update.html";i:1565240153;s:78:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\Public\base.html";i:1563256854;}*/ ?>
<!DOCTYPE html>
<html lang="en">
      ...
      <div class="tab-content">
        ...
        <div id="demo-tabs-box-1" class="tab-pane fade in active">
          <div class="form-group has-feedback">
            ...
            <div class="col-lg-4">
              <input type="text" class="form-control" '' name="identity" disabled value="<?php echo $update['identity']; ?>" placeholder="用户类型" data-bv-field="name">
            ...
            <div class="col-lg-4">
              <input type="number" step="0.01" class="form-control"  '' name="username" value="<?php echo $update['username']; ?>" placeholder="用户名称" data-bv-field="name">
              <i class="form-control-feedback" data-bv-icon-for="name" style="display: none;"></i>
            </div>
          </div> -->
          <?php if(\think\Cookie::get('AdminUserType') == 1): ?>
          <div class="form-group has-feedback">
            <label class="col-lg-3 control-label">所属分店</label>
            <div class="col-lg-7">
              <select name="belong_to_store" id="SelectVal" style="width: 300px;">
                <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                <option value="<?php echo $vo['id']; ?>"<?php if($vo['id']==$update['belong_to_store']){echo 'selected';} ?>><?php echo $vo['name']; ?></option>
          ...
          <div class="form-group has-feedback">
            ...
            <div class="col-lg-4">
              <input type="text" class="form-control"  '' name="nickname" value="<?php echo $update['nickname']; ?>" placeholder="昵称" data-bv-field="name">
              <i class="form-control-feedback" data-bv-icon-for="name" style="display: none;"></i>
            </div>
          </div>
          <div class="form-group has-feedback">
            ...
            <label class="col-lg-3 control-label">用户头像</label>
            <div class="col-lg-4">
              <input type="file" class="form-control" name="photo" placeholder="用户头像" data-bv-field="name">
              <i class="form-control-feedback" data-bv-icon-for="name" style="display: none;"></i>
            </div>
          </div>
           <div class="form-group has-femobileedback">
            ...
            <div class="col-lg-4">
              <input type="number" class="form-control"  '' name="mobile" value="<?php echo $update['mobile']; ?>" placeholder="手机号码" data-bv-field="name">
              <i class="form-control-feedback" data-bv-icon-for="name" style="display: none;"></i>
            </div>
          </div>
            <div class="form-group has-feedback">
            ...
            <div class="col-lg-4">
              <input type="number" step="0.01" class="form-control"  name="price" value="<?php echo $update['price']; ?>" placeholder="基本薪资" data-bv-field="name">
              <i class="form-control-feedback" data-bv-icon-for="name" style="display: none;"></i>
            </div>
          </div>
        ...
        <div class="form-group has-feedback">
            ...
            <div class="col-lg-7">
              <input type="radio" name="status" value="0" <?php echo $update['status'] == 0 ? "checked" : ''; ?>>冻结
              <input type="radio" name="status" value="1" <?php echo $update['status'] == 1 ? "checked" : ''; ?>>正常
...
<script>
  ...
  $(function(){
      ...
      $('#CreateSubmit').click(function(){
        ...
        $.ajax({
          type: 'POST',
          url:'/Admin/User/DoUpdate?id=<?php echo $update['id']; ?>',
          data:formData,
          contentType: false,
          processData: false,
