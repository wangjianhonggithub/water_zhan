<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:90:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\Statistics\month_zhichu.html";i:1568946556;s:78:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\Public\base.html";i:1563256854;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<div class="panel">
    <div class="panel-heading">
        <h3 class="panel-title">成本支出-月统计</h3>
    </div>

    <div id="demo-custom-toolbar2" class="table-toolbar-left" style="width:500px;margin-left: 25px">
        <a href="/Admin/Statistics/expenditure?type=1" class="btn btn-xs btn-rounded btn-success">天统计</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
