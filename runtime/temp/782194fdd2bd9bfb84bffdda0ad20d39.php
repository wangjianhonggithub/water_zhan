<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:81:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\Address\update.html";i:1563256844;s:78:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\Public\base.html";i:1563256854;}*/ ?>
<!DOCTYPE html>
<html lang="en">
      ...
      <div class="tab-content">
        ...
        <div id="demo-tabs-box-1" class="tab-pane fade in active">
          <div class="form-group has-feedback">
            ...
            <div class="col-lg-7">
              <textarea name="title" style="height:270px; width:700px;" ><?php echo $update['title']; ?></textarea>
...
<script>
  $(function(){
      $('#UpdateSubmit').click(function(){
        ...
        $.ajax({
          type: 'POST',
          url:'/Admin/Address/DoUpdate?id=<?php echo $update['id']; ?>',
          data:formData,
          contentType: false,
          processData: false,
