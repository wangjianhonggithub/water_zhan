<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:84:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\Bucket\bucketList.html";i:1563256846;s:78:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\Public\base.html";i:1563256854;}*/ ?>
<!DOCTYPE html>
<html lang="en">
            ...
            <tbody>
               <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                <tr>
                    ...
                    <td style="color:red;"><?php echo $vo['validity']; ?></td>
                    <td>
                        <button type="button" class="btn btn-mint subOrder" data-id="<?php echo $vo['id']; ?>">提醒</button>
                    	<!-- <a href="/Admin/Bucket/Tixing?id=<?php echo $vo['id']; ?>" class="btn btn-xs btn-rounded btn-success">提醒</a> -->
                    </td>
                </tr>
