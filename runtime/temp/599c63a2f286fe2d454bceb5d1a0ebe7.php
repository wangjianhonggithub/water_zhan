<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:81:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\StoreGoods\add.html";i:1565860716;s:78:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\Public\base.html";i:1563256854;}*/ ?>
<!DOCTYPE html>
<html lang="en">
      ...
      <div class="tab-content">
        ...
        <div id="demo-tabs-box-1" class="tab-pane fade in active">
          ...
          <div class="form-group has-feedback">
            ...
            <div class="col-lg-7">
              <input type="radio" name="goodsType" value="1" checked> <label>否</label>

              <input type="radio" style="margin-left: 20px;"  name="goodsType" value="2"> <label>是</label>
          ...
          <div class="form-group has-feedback">
            ...
            <div class="col-lg-4">
              <input type="text" class="form-control" name="goods_name" placeholder="商品名称" data-bv-field="name">
          ...
          <div class="form-group has-feedback">
            ...
            <div class="col-lg-4">
              <input type="number" step="0.01" class="form-control" value="0.00" name="goods_pic" placeholder="商品单价" data-bv-field="name">
              <i class="form-control-feedback" data-bv-icon-for="name" style="display: none;"></i>
            </div>
          </div>
          <div class="form-group has-feedback">
            ...
            <div class="col-lg-4">
              <input type="number" step="0.01" class="form-control" value="0.00" name="ordinaryMoney" placeholder="返现" data-bv-field="name">
              <i class="form-control-feedback" data-bv-icon-for="name" style="display: none;"></i>
            </div>
          </div>
          <div class="form-group has-feedback">
            ...
            <div class="col-lg-4">
              <input type="number" step="0.01" class="form-control" value="0.00" name="silverCardMoney" placeholder="返现" data-bv-field="name">
              <i class="form-control-feedback" data-bv-icon-for="name" style="display: none;"></i>
            </div>
          </div>
          <div class="form-group has-feedback">
            ...
            <div class="col-lg-4">
              <input type="number" step="0.01" class="form-control" value="0.00" name="goldenCardMoney" placeholder="返现" data-bv-field="name">
              <i class="form-control-feedback" data-bv-icon-for="name" style="display: none;"></i>
            </div>
          </div>
          <!--<div class="form-group has-feedback">-->
            ...
            <!--<div class="col-lg-4">-->
              <!--<input type="number" class="form-control" name="stock"  placeholder="库存" data-bv-field="name">-->
              <!--<i class="form-control-feedback" data-bv-icon-for="name" style="display: none;"></i>-->
            <!--</div>-->
          <!--</div>-->
          <div class="form-group has-feedback">
            ...
            <div class="col-lg-4">
              <input type="file" class="form-control" name="thumb_img" value="0.00" placeholder="缩略图" data-bv-field="name">
            </div>
          </div>
         <!--  <div class="form-group has-feedback">
            <label class="col-lg-3 control-label">编号</label>
            <div class="col-lg-4">
              <input type="text" class="form-control" name="serival" placeholder="编号" data-bv-field="name">
              <i class="form-control-feedback" data-bv-icon-for="name" style="display: none;"></i>
            </div>
          </div> -->
         ...
         <div class="form-group has-feedback">
            ...
            <div class="col-lg-4">
              <script id="goods_info" name="goods_info" type="text/plain"></script>
            </div>
          </div>
        </div>
       </div>
