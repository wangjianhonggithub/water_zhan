<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:96:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\Statistics\goods_index_detail.html";i:1569471158;s:78:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\Public\base.html";i:1563256854;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<div class="panel">
    <div class="panel-heading">
        <h3 class="panel-title"><a href="/Admin/Statistics/goods">品牌销量统计</a>><?php echo $goods_name; ?></h3>
    </div>
            ...
            <tbody>
               <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                <tr>
                    ...
                    <td style="text-align: center"><?php echo $vo['store_name']; ?></td>
                    <td style="text-align: center"><?php echo $vo['month']; ?></td>
                    <td style="text-align: center">
                        <a href="/Admin/Statistics/goodsx_details?goods_name=<?php echo $vo['goods_name']; ?>&month=<?php echo $vo['month']; ?>&store_id=<?php echo $vo['store_id']; ?>" class="btn btn-xs btn-rounded btn-success">查看详情</a>
                    </td>
