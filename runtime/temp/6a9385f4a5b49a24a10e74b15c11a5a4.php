<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:85:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\Order\bucketAction.html";i:1567390159;s:78:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\Public\base.html";i:1563256854;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  ...
  <form id="demo-bv-errorcnt" class="form-horizontal bv-form" action="" method="POST" novalidate="novalidate">
    ...
    <div class="panel-body">
      <div class="tab-content">
        ...
        <div class="form-group has-feedback">
            <label class="col-lg-3 control-label">桶数量</label>
            <div class="col-lg-4">
              <input type="text" class="form-control" disabled  name="orderNo" value="<?php echo $info['orderCate']==2?$info['num'] : $info['bucketNum']; ?>" placeholder="桶数量" data-bv-field="name">
              <i class="form-control-feedback" data-bv-icon-for="name" style="display: none;"></i>
            </div>
        </div>


<?php if($info['orderCate'] == 2): ?>
        <div class="form-group has-feedback">
...
<?php if($info['orderCate'] == 3): ?>
        ...
        <?php endif; if($info['orderTstatus'] == 1): ?>
            <div class="panel-footer clearfix">
              <div class="col-lg-7 col-lg-offset-3">
                <button type="button" class="btn btn-mint subOrder" data-id="<?php echo $info['id']; ?>" data-type="1" >同意</button>
              </div>
            </div>
        <?php endif; ?>
