<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:72:"E:\PHPTutorial\WWW\jjzs\public/../application/admin\view\Goods\show.html";i:1564389871;s:73:"E:\PHPTutorial\WWW\jjzs\public/../application/admin\view\Public\base.html";i:1563256854;}*/ ?>
<!DOCTYPE html>
<html lang="en">
      ...
      <div class="tab-content">
        ...
        <div id="demo-tabs-box-1" class="tab-pane fade in active">
          <div class="form-group has-feedback">
            ...
            <div class="col-lg-7">
              <select name="cid" id="SelectVal" disabled style="width: 300px;">
                <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                <option value="<?php echo $vo['id']; ?>"<?php echo '<?'; ?>
 php if($vo['id']==$update['cid']){echo 'selected';} ?>><?php echo $vo['name']; ?></option>
                <?php endforeach; endif; else: echo "" ;endif; ?>
              </select>
            </div>
          </div>
          <div class="form-group has-feedback">
            <label class="col-lg-3 control-label">空桶分类</label>
            <div class="col-lg-4">
              <input type="text" class="form-control" disabled  name="goodsType" value="<?php echo $bucketType['name']; ?>" placeholder="商品状态" data-bv-field="name">
          ...
          <div class="form-group has-feedback">
            ...
            <div class="col-lg-4">
              <input type="text" class="form-control" disabled  name="goodsType" value="<?php echo $update['goodsType'] == 1 ? '否' : '是'; ?>" placeholder="商品状态" data-bv-field="name">
              <i class="form-control-feedback" data-bv-icon-for="name" style="display: none;"></i>
            </div>
          </div>
          <div class="form-group has-feedback">
            ...
            <div class="col-lg-4">
              <input type="text" class="form-control" disabled name="goods_name" value="<?php echo $update['goods_name']; ?>" placeholder="商品名称" data-bv-field="name">
              <i class="form-control-feedback" data-bv-icon-for="name" style="display: none;"></i>
            </div>
          </div>
                    <div class="form-group has-feedback">
            ...
            <div class="col-lg-4">
              <input type="number" step="0.01" class="form-control"  disabled name="goods_pic" value="<?php echo $update['goods_pic']; ?>" placeholder="商品单价" data-bv-field="name">
              <i class="form-control-feedback" data-bv-icon-for="name" style="display: none;"></i>
            </div>
          </div>
           <div class="form-group has-feedback">
            ...
            <div class="col-lg-4">
              <input type="number" step="0.01" class="form-control"  disabled name="ordinaryMoney" value="<?php echo $update['ordinaryMoney']; ?>" placeholder="返现" data-bv-field="name">
              <i class="form-control-feedback" data-bv-icon-for="name" style="display: none;"></i>
            </div>
          </div>
          <div class="form-group has-feedback">
            ...
            <div class="col-lg-4">
              <input type="number" step="0.01" class="form-control"  disabled name="silverCardMoney" value="<?php echo $update['silverCardMoney']; ?>"placeholder="返现" data-bv-field="name">
              <i class="form-control-feedback" data-bv-icon-for="name" style="display: none;"></i>
            </div>
          </div>
          <div class="form-group has-feedback">
            ...
            <div class="col-lg-4">
              <input type="number" step="0.01" class="form-control" disabled  name="goldenCardMoney" value="<?php echo $update['goldenCardMoney']; ?>" placeholder="返现" data-bv-field="name">
              <i class="form-control-feedback" data-bv-icon-for="name" style="display: none;"></i>
            </div>
          </div>
          <div class="form-group has-feedback">
            ...
            <div class="col-lg-4">
              <input type="number" class="form-control" name="stock" disabled placeholder="库存" value="<?php echo $update['stock']; ?>" data-bv-field="name">
              <i class="form-control-feedback" data-bv-icon-for="name" style="display: none;"></i>
            </div>
          </div>
        ...
        <div class="form-group has-feedback">
            ...
            <div class="col-lg-4">
              <input type="text" step="0.01" class="form-control" disabled  name="status" value="<?php echo $update['status'] == 0 ? "已下架" : "正常"; ?>" placeholder="商品状态" data-bv-field="name">
              <i class="form-control-feedback" data-bv-icon-for="name" style="display: none;"></i>
            </div>
          </div>
