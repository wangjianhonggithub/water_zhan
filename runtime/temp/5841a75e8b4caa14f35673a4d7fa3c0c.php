<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:79:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\Banner\index.html";i:1563256844;s:78:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\Public\base.html";i:1563256854;}*/ ?>
<!DOCTYPE html>
<html lang="en">
            ...
            <tbody>
               <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                <tr>
                    ...
                    <td><img src="<?php echo $vo['banner_img']; ?>" alt="" style="width: 120px;height: 80px;"></td>
                    <td style="color:red;"><?php if($vo['is_type'] == 0){echo "首页";}else{echo "交流互动";} ?></td>
