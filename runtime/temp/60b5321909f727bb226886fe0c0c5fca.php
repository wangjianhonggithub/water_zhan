<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:83:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\empty_bucket\add.html";i:1564126105;s:78:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\Public\base.html";i:1563256854;}*/ ?>
<!DOCTYPE html>
<html lang="en">
      ...
      <div class="tab-content">
        <div id="demo-tabs-box-1" class="tab-pane fade in active">
          <div class="form-group has-feedback">
              <label class="col-lg-3 control-label"><?php echo $name; ?></label>
            <div class="col-lg-7">
...
<script>
  $(function(){
      $('#CreateSubmit').click(function(){
        var url = "<?php echo url('EmptyBucket/doAddBucket'); ?>";
