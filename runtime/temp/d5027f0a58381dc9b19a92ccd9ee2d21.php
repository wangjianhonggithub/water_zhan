<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:84:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\empty_bucket\list.html";i:1565156100;s:78:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\Public\base.html";i:1563256854;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<div class="panel">
    <div class="panel-heading">
        <h3 class="panel-title">店铺名称：<?php echo $user_name; ?></h3>
    </div>
            ...
            <tbody>
               <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $key=>$vo): ?>
                <tr>
                    ...
                    <td>
                        <?php if($flag == 'o'): ?>
                        <a href="<?php echo url('EmptyBucket/applyForBucket',array('id'=>$vo['id'])); ?>" class="btn btn-xs btn-rounded btn-mint">申请空桶</a>
                        <?php endif; if($flag == 'a'): ?>
                            <a href="<?php echo url('EmptyBucket/addBucket',array('user_id'=>$user_id,'name'=>$vo['goods_name'])); ?>" class="btn btn-xs btn-rounded btn-mint">分配空桶</a>
                        <?php endif; ?>
                            <a href="<?php echo url('EmptyBucket/assignBucketLogs',array('user_id'=>$user_id,'name'=>$vo['goods_name'])); ?>" class="btn btn-xs btn-rounded btn-mint">查询分配记录</a>
                            <!-- <button type="button" class="btn btn-success"><?php echo $user_id==1?'申请中':'无申请'; ?></button> -->
                    </td>
                </tr>
