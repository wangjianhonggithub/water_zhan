<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:85:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\BucketCategory\add.html";i:1565228853;s:78:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\Public\base.html";i:1563256854;}*/ ?>
<!DOCTYPE html>
<html lang="en">
      ...
      <div class="tab-content">
        ...
        <div id="demo-tabs-box-1" class="tab-pane fade in active">
          <div class="form-group has-feedback">
            ...
            <div class="col-lg-7">
              <input type="text" class="form-control" name="name" placeholder="分类名称" data-bv-field="name">
          ...
          <!-- <div class="form-group has-feedback">
            ...
            <div class="col-lg-7">
              <input type="text" class="form-control" name="description" placeholder="分类简述" data-bv-field="name">
              <i class="form-control-feedback" data-bv-icon-for="name" style="display: none;"></i>
            </div>
          </div>
          <div class="form-group has-feedback">
          ...
          <div class="form-group has-feedback">
            ...
            <div class="col-lg-7">
              <input type="text" class="form-control" name="prompt" placeholder="温馨提示" data-bv-field="name">
            </div>
          </div> -->
        </div>
       </div>
...
<script>
  $(function(){
      $('#CreateSubmit').click(function(){
        ...
        $.ajax({
          type: 'POST',
          url:'/Admin/BucketBucketCategory/DoAdd',
          data:formData,
          contentType: false,
          processData: false,
