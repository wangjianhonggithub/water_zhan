<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:77:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\User\xinzi.html";i:1563256854;s:78:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\Public\base.html";i:1563256854;}*/ ?>
<!DOCTYPE html>
<html lang="en">
        ...
        <table id="demo-dt-addrow" class="table table-striped table-bordered" cellspacing="0" width="100%">
            <thead>
                <tr>
                    ...
                    <th class="min-tablet">日期</th>
                    <th class="min-tablet">薪资</th>
                </tr>
            </thead>
            <tbody>
               <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                <tr>
                    ...
                    <td><?php echo date('Y-m',$vo['createTime']); ?></td>
                    <td><?php echo $vo['xinzi']; ?></td>
                </tr>
