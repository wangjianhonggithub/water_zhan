<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:89:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\BranchStore\Song_index.html";i:1568706458;s:78:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\Public\base.html";i:1563256854;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<div class="panel">
    <div class="panel-heading">
        <h3 class="panel-title"><a href="/Admin/Branch_store/management?id=<?php echo $id; ?>"><?php echo $store_name; ?></a>>送水员列表</h3>
    </div>
            ...
            <tbody>
               <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                <tr>
                    ...
                    <!-- <td>
                        <?php foreach(explode(',',$vo['photo']) as $goods){ if(!empty($goods)){?>
                    ...
                    <td><?php echo date('Y-m-d H:i:s',$vo['update_time']); ?></td>
                    <td>
                        <a href="/Admin/User/song_show/<?php echo $vo['id']; ?>" class="btn btn-xs btn-rounded btn-mint">查看</a>
                    	<a href="/Admin/User/update/<?php echo $vo['id']; ?>" class="btn btn-xs btn-rounded btn-warning">修改</a>
                        <?php if(\think\Cookie::get('AdminUserType') == 2): ?>
                        <a href="/Admin/User/pianqu/<?php echo $vo['id']; ?>" class="btn btn-xs btn-rounded btn-mint">分配片区</a>
                        <?php endif; ?>
                        <a href="/Admin/User/xinzi/<?php echo $vo['id']; ?>" class="btn btn-xs btn-rounded btn-mint">薪资记录</a>
                        <a href="/Admin/User/update_pwd/<?php echo $vo['id']; ?>" class="btn btn-xs btn-rounded btn-warning">重置登陆密码</a>
