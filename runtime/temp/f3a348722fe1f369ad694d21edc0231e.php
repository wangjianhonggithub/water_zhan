<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:79:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\Config\index.html";i:1563256848;s:78:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\Public\base.html";i:1563256854;}*/ ?>
<!DOCTYPE html>
<html lang="en">
      ...
      <div class="tab-content">
        ...
        <div id="demo-tabs-box-1" class="tab-pane fade in active">
          <div class="form-group has-feedback">
            ...
            <div class="col-lg-4">
              <input type="number" step="0.01" class="form-control" name="warehousing" value="<?php echo $update['warehousing']; ?>" placeholder="商品仓储费" data-bv-field="name">
            ...
            <div class="col-lg-4">
              <input type="number" step="0.01" class="form-control" name="freight" value="<?php echo $update['freight']; ?>" placeholder="商品运费" data-bv-field="name">
              <i class="form-control-feedback" data-bv-icon-for="name" style="display: none;"></i>
            </div>
          </div>
          <div class="form-group has-feedback">
            ...
            <div class="col-lg-4">
              <input type="number" step="0.01" class="form-control" name="extract" value="<?php echo $update['extract']; ?>" placeholder="员工薪资提成" data-bv-field="name">
              <i class="form-control-feedback" data-bv-icon-for="name" style="display: none;"></i>
            </div>
          </div>
          <div class="form-group has-feedback">
            ...
            <div class="col-lg-4">
              <input type="number" step="0.01" class="form-control" name="bucketDeposit" value="<?php echo $update['bucketDeposit']; ?>" placeholder="桶押金" data-bv-field="name">
              <i class="form-control-feedback" data-bv-icon-for="name" style="display: none;"></i>
            </div>
          </div>
          ...
          <div class="form-group has-feedback">
            ...
            <div class="col-lg-4">
              <input type="number" step="0.01" class="form-control" name="bucketRentMonth" value="<?php echo $update['bucketRentMonth']; ?>" placeholder="桶租金/月" data-bv-field="name">
              <i class="form-control-feedback" data-bv-icon-for="name" style="display: none;"></i>
            </div>
          </div>
          ...
          <div class="form-group has-feedback">
            ...
            <div class="col-lg-4">
              <input type="number" step="0.01" class="form-control" name="bucketRentYear" value="<?php echo $update['bucketRentYear']; ?>" placeholder="桶租金/年" data-bv-field="name">
              <i class="form-control-feedback" data-bv-icon-for="name" style="display: none;"></i>
            </div>
          </div>
          ...
          <div class="form-group has-feedback">
            ...
            <div class="col-lg-4">
              <input type="number" step="0.01" class="form-control" name="goldCard" value="<?php echo $update['goldCard']; ?>" placeholder="金卡额度" data-bv-field="name">
              <i class="form-control-feedback" data-bv-icon-for="name" style="display: none;"></i>
            </div>
          </div>
          <div class="form-group has-feedback">
            ...
            <div class="col-lg-4">
              <input type="number" step="0.01" class="form-control" name="silverCard" value="<?php echo $update['silverCard']; ?>" placeholder="银卡额度" data-bv-field="name">
              <i class="form-control-feedback" data-bv-icon-for="name" style="display: none;"></i>
            </div>
          </div>
<!-- 
	        <div class="form-group has-feedback">
	            ...
	            <div class="col-lg-4">
	                <script id="answer" name="qq" type="text/plain"><?php echo $update['qq']; ?></script>
	            </div>
	        </div> -->
        </div>
       </div>
