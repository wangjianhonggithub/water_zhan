<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:78:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\Order\index.html";i:1566893544;s:78:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\Public\base.html";i:1563256854;}*/ ?>
<!DOCTYPE html>
<html lang="en">
            ...
            <tbody>
               <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                <tr>
                    ...
                    <td <?php if($vo['depositStatus'] == 2): ?> style="color:red;"<?php endif; ?>><?php echo $vo['orderNo']; ?></td>
                    
                    <td style="color:red;"><?php if($vo['depositStatus'] == 2): ?>客户未支付桶押金订水。请管理员注意处理<?php endif; ?></td>

                    <td style="color:red;">
                    <?php if($vo['orderGoodsType'] == 3): ?>客户为<?php echo $vo['shenfen']; ?>，未正常支付租金<?php echo $vo['bucketNumbers']; ?>桶<?php endif; ?></td>
                    <?php if(cookie('AdminUserType') == 1): if($vo['belong_store'] == '公海订单'): ?>
                    <td style="color:red;"><?php echo $vo['belong_store']; ?></td>
                    <?php else: ?>
                    <td><?php echo $vo['belong_store']; ?></td>
                    <?php endif; endif; ?>
                    <td><?php echo $vo['userName']; ?></td>
                    <td><?php echo $vo['deliverType']==1?'商家配送' : '自取'; ?></td>
                    <td><?php echo $vo['realTotalMoney']; ?></td>
                    <!-- <td><?php echo $vo['realTotalMoney']; ?></td> -->
                    <td><?php echo $vo['isPay']==1?'已支付' : '未支付'; ?></td>
                    <td><?php echo $vo['payType']; ?></td>
                    <td><?php echo $vo['createTime']; ?></td>
                    <td><?php echo $vo['payTime']; ?></td>
                    <?php if(cookie('AdminUserType') == 2): ?>
                        <td><?php echo $vo['waterman_owe_bucket']; ?></td>
                    <?php endif; ?>
                    <td style="color:red;"><?php echo $vo['orderStatus']; ?></td>
                    <td>
                    	<a href="/Admin/Order/getInfo?id=<?php echo $vo['id']; ?>" class="btn btn-xs btn-rounded btn-success">查看详情</a>
                        <!--<a href="javascript:;" data-id="<?php echo $vo['id']; ?>" class="btn btn-xs DeleteSubmit btn-rounded Delete btn-warning">修改订单</a>-->
                        <?php if($vo['belong_store'] == '公海订单' && $vo['deliverType'] ==2 && $vo['orderStatus'] ==1): ?>
                        <a href="javascript:;" data-id="<?php echo $vo['id']; ?>" class="btn btn-xs DeleteSubmit btn-rounded Delete btn-warning">接单</a>
                        <?php endif; ?>
                    </td>
                </tr>
