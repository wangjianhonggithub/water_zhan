<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:92:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\BranchStore\storeOrderTui.html";i:1568715184;s:78:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\Public\base.html";i:1563256854;}*/ ?>
<!DOCTYPE html>
<html lang="en">
            ...
            <tbody>
               <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                <tr>
                    ...
                    <td style="color: red"><?php echo $vo['orderTstatus']==2?'已处理' : '未处理'; ?></td>
                    <td>
                    	<a href="/Admin/Order/getTuiKuanInfo?id=<?php echo $vo['id']; ?>" class="btn btn-xs btn-rounded btn-success">查看详情</a>
                    </td> 
                </tr>
