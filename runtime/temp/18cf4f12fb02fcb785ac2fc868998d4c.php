<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:86:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\Order\bucketListTui.html";i:1566783952;s:78:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\Public\base.html";i:1563256854;}*/ ?>
<!DOCTYPE html>
<html lang="en">
            ...
            <tbody>
               <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                <tr>
                    ...
                    <td><?php echo $vo['bucketNum']; ?></td>
                    <td><?php echo $vo['isPay']==1?'已支付' : '未支付'; ?></td>
                    <td><?php echo $vo['payType']; ?></td>
                    <td><?php echo $vo['createTime']; ?></td>
                    <td><?php echo $vo['payTime']; ?></td>
                    <td style="color: red"><?php echo $vo['orderTstatus']==1?'未处理' : '已处理'; ?></td>
                    <td>
                    	<a href="/Admin/Order/getBucketInfo?id=<?php echo $vo['id']; ?>" class="btn btn-xs btn-rounded btn-success">查看详情</a>
                    </td>
                </tr>
