<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:88:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\Statistics\day_shouyi.html";i:1569315021;s:78:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\Public\base.html";i:1563256854;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<div class="panel">
    <div class="panel-heading">
        <h3 class="panel-title">资金流水收益-日统计</h3>
    </div>

    <div id="demo-custom-toolbar2" class="table-toolbar-left" style="width:500px;margin-left: 25px">
        <a href="/Admin/Statistics/capitalgains?type=1" class="btn btn-xs btn-rounded btn-success">日统计</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <a href="/Admin/Statistics/capitalgains?type=2" class="btn btn-xs btn-rounded btn-success">月统计</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <a href="/Admin/Statistics/capitalgains?type=3" class="btn btn-xs btn-rounded btn-success">年统计</a>
    ...
    <div class="panel-body">
        <table id="demo-dt-addrow" class="table table-striped table-bordered" cellspacing="0" width="100%">
            <thead>
            <tr>
                <th style="text-align: center">桶租金收益</th>
                <th style="text-align: center">遗失水桶收益(数量)</th>
                <th style="text-align: center">仓储费收益</th>
                <th style="text-align: center">商品差价收益</th>
                <th style="text-align: center">商品成本收益</th>
                <th style="text-align: center">配送费收益</th>
            ...
            <tr>
                <td style="text-align: center"><?php echo $vo['rent_income']; ?></td>
                <td style="text-align: center"><?php echo $vo['lose_bucket']*40; ?>&nbsp;(<?php echo $vo['lose_bucket']; ?>)</td>
                <td style="text-align: center"><?php echo $vo['cangchu']; ?></td>
                <td style="text-align: center"><?php echo $vo['goods_diff']; ?></td>
                <td style="text-align: center"><?php echo $vo['goods_cost']; ?></td>
                <td style="text-align: center"><?php echo $vo['yunfei']; ?></td>
                <td style="text-align: center"><?php echo date("Y-m-d",$vo['statistical_time']); ?></td>
