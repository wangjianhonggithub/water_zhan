<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:78:"E:\PHPTutorial\WWW\jjzs\public/../application/admin\view\StoreStock\index.html";i:1564110460;s:73:"E:\PHPTutorial\WWW\jjzs\public/../application/admin\view\Public\base.html";i:1563256854;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="padding border-bottom" >
        <ul class="search" style="padding:10px;">
            <li style="float: left;padding-bottom: 10px">
                <a href="/Admin/StoreGoodsAdd" id="demo-dt-addrow-btn" class="btn btn-primary"><i class="demo-pli-plus"></i> 添加新产品到库存</a> </li>
            </li>
        </ul>
    </div>
    <div class="panel-body">
        <table id="demo-dt-addrow" class="table table-striped table-bordered" cellspacing="0" width="100%">
            ...
            <tr>
                <th>ID</th>
                <th>产品ID</th>
                <th class="min-tablet">产品名称</th>
                <th class="min-tablet">单个成本</th>
                <th class="min-tablet">库存</th>
                <th class="min-tablet">添加产品时间</th>
                <th class="min-tablet">修改产品时间</th>
            ...
            <tr class="content">
                ...
                <td>
                    <a href="/Admin/StoreStockUpdata?goods_id=<?php echo $vo['goods_id']; ?>"  data-id="<?php echo $vo['id']; ?>" class="btn btn-xs btn-rounded btn-warning">修改</a>
                    <a href="/Admin/StoreLogs?goods_id=<?php echo $vo['goods_id']; ?>"  data-id="<?php echo $vo['id']; ?>" class="btn btn-xs btn-rounded btn-mint">补货记录</a>
                </td>
            </tr>
