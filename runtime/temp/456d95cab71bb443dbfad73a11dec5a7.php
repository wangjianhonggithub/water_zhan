<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:82:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\User\Shang_show.html";i:1563256858;s:78:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\Public\base.html";i:1563256854;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<div class="panel">
  ...
  <br/>
  <br/>
  <!-- Panel body style="padding: 15px 20px 180px;" -->
        ...
        <div id="demo-tabs-box-1" class="tab-pane fade in active">
          ...
          <div class="form-group has-feedback">
           ...
           <div class="form-group has-feedback">
            ...
            <div class="col-lg-4">
              <input type="number" step="0.01" disabled class="form-control"  name="fanxian" value="<?php echo $update['fanxian']; ?>" placeholder="商家返现比例" data-bv-field="name">
              <i class="form-control-feedback" data-bv-icon-for="name" style="display: none;"></i>
            </div>
          </div>
          ...
          <div class="form-group has-feedback">
            ...
            <div class="col-lg-7">
              <input type="radio" name="status" disabled value="0" <?php echo $update['status'] == 0 ? "checked" : ''; ?>>冻结
              <input type="radio" name="status" disabled value="1" <?php echo $update['status'] == 1 ? "checked" : ''; ?>>正常
