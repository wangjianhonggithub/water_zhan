<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:92:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\Bucket\substitutionAction.html";i:1563256846;s:78:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\Public\base.html";i:1563256854;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  ...
  <form id="demo-bv-errorcnt" class="form-horizontal bv-form" action="" method="POST" novalidate="novalidate">
    ...
    <div class="panel-body">
      <div class="tab-content">
        ...
        <div class="form-group has-feedback">
            <label class="col-lg-3 control-label">申请用户</label>
            <div class="col-lg-4">
              <input type="text" class="form-control" disabled  name="userName" value="<?php echo $info['userName']; ?>" placeholder="订单号" data-bv-field="name">
              <i class="form-control-feedback" data-bv-icon-for="name" style="display: none;"></i>
            </div>
        </div>
        ...
        <div class="form-group has-feedback">
            ...
            <div class="col-lg-4">
              <input type="text" class="form-control" disabled  name="mobile" value="<?php echo $info['mobile']; ?>" placeholder="订单号" data-bv-field="name">
              <i class="form-control-feedback" data-bv-icon-for="name" style="display: none;"></i>
            </div>
        </div>
        <div class="form-group has-feedback">
            <label class="col-lg-3 control-label">提交时间</label>
            <div class="col-lg-4">
              <input type="text" class="form-control" disabled  name="createTime" value="<?php echo $info['createTime']; ?>" placeholder="订单号" data-bv-field="name">
              <i class="form-control-feedback" data-bv-icon-for="name" style="display: none;"></i>
            </div>
        </div>
        <div class="form-group has-feedback">
            ...
            <div class="col-lg-4">
              <input type="text" class="form-control" disabled  name="number" value="1" placeholder="订单号" data-bv-field="name">
              <i class="form-control-feedback" data-bv-icon-for="name" style="display: none;"></i>
            </div>
        </div>
        <div class="form-group has-feedback">
            <label class="col-lg-3 control-label">租金类型</label>
            <div class="col-lg-4">
              <input type="text" class="form-control" disabled  name="number" value="<?php echo $info['type'] == 1 ? "月租" : "年租"; ?>" placeholder="订单号" data-bv-field="name">
              <i class="form-control-feedback" data-bv-icon-for="name" style="display: none;"></i>
            </div>
        </div>
        <div class="form-group has-feedback">
            <label class="col-lg-3 control-label">退款押金</label>
            <div class="col-lg-4">
              <input type="text" class="form-control" disabled  name="number" value="<?php echo $info['bucketDeposit']; ?>" placeholder="退款押金" data-bv-field="name">
              <i class="form-control-feedback" data-bv-icon-for="name" style="display: none;"></i>
            </div>
        </div>
        ...
        <?php if($info['status'] == 0): ?>
            <div class="panel-footer clearfix">
              <div class="col-lg-7 col-lg-offset-3">
                <button type="button" class="btn btn-mint subOrder" data-id="<?php echo $info['id']; ?>" data-examine="1" >同意</button>
              </div>
            </div>
        <?php endif; ?>
