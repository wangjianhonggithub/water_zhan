<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:84:"E:\PHPTutorial\WWW\jjzs\public/../application/admin\view\empty_bucket\user_list.html";i:1564365203;s:73:"E:\PHPTutorial\WWW\jjzs\public/../application/admin\view\Public\base.html";i:1563256854;}*/ ?>
<!DOCTYPE html>
<html lang="en">
               ...
               <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $key=>$vo): ?>
                <tr>
                    ...
                    <!-- 	<a href="/Admin/Bucket/substitutionAction?id=<?php echo $vo['id']; ?>" class="btn btn-xs btn-rounded btn-success">操作</a> -->
                        <!-- <a href="javascript:;"  class="btn btn-xs btn-rounded btn-warning">修改</a> -->
                        <a href="/Admin/EmptyBucket/fenpei?id=<?php echo $vo['id']; ?>"  class="btn btn-xs btn-rounded btn-mint">分配店长</a>
