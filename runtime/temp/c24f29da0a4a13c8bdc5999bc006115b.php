<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:76:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\User\show.html";i:1563256854;s:78:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\Public\base.html";i:1563256854;}*/ ?>
<!DOCTYPE html>
<html lang="en">
      ...
      <div class="tab-content">
        ...
        <div id="demo-tabs-box-1" class="tab-pane fade in active">
          <div class="form-group has-feedback">
            ...
            <div class="col-lg-4">
              <input type="text" class="form-control" disabled name="identity" value="<?php echo $update['identity']; ?>" placeholder="用户类型" data-bv-field="name">
        ...
        <!--   <div class="form-group has-feedback">
            ...
            <div class="col-lg-4">
              <input type="number" step="0.01" class="form-control"  disabled name="username" value="<?php echo $update['username']; ?>" placeholder="用户名称" data-bv-field="name">
              <i class="form-control-feedback" data-bv-icon-for="name" style="display: none;"></i>
            </div>
          </div> -->
          <div class="form-group has-feedback">
            ...
            <div class="col-lg-4">
              <input type="text" class="form-control"  disabled name="nickname" value="<?php echo $update['nickname']; ?>" placeholder="昵称" data-bv-field="name">
              <i class="form-control-feedback" data-bv-icon-for="name" style="display: none;"></i>
            </div>
          </div>
          <div class="form-group has-feedback">
            ...
            <div class="col-lg-4">
              <img src="<?php echo $update['photo']; ?>" alt="" style="width: 150px;height: 120px;">
            </div>
          </div>
           <div class="form-group has-femobileedback">
            <label class="col-lg-3 control-label">手机号码</label>
            <div class="col-lg-4">
              <input type="number" class="form-control"  disabled name="mobile" value="<?php echo $update['mobile']; ?>" placeholder="手机号码" data-bv-field="name">
              <i class="form-control-feedback" data-bv-icon-for="name" style="display: none;"></i>
            </div>
          </div>
           <div class="form-group has-feedback">
            ...
            <div class="col-lg-4">
              <input type="text" class="form-control"  disabled name="identification" value="<?php echo $update['identification']; ?>" placeholder="会员类型" data-bv-field="name">
              <i class="form-control-feedback" data-bv-icon-for="name" style="display: none;"></i>
            </div>
          </div>
           <div class="form-group has-feedback">
            ...
            <div class="col-lg-4">
            <input type="text" class="form-control"  disabled name="level" value="<?php echo $update['level']==1?'普通会员' : ($update['level'] == 2 ? '银卡会员' : ($update['level'] == 3 ? '金卡会员' : '')); ?>" placeholder="会员级别" data-bv-field="name">
              <i class="form-control-feedback" data-bv-icon-for="name" style="display: none;"></i>
            </div>
          </div>
           <div class="form-group has-feedback">
            ...
            <div class="col-lg-4">
              <input type="number" step="0.01" class="form-control"  disabled name="money" value="<?php echo $update['money']; ?>" placeholder="账户余额" data-bv-field="name">
              <i class="form-control-feedback" data-bv-icon-for="name" style="display: none;"></i>
            </div>
          </div>
        <!--   <div class="form-group has-feedback">
            <label class="col-lg-3 control-label">基本薪资</label>
            <div class="col-lg-4">
              <input type="number" step="0.01" class="form-control"  disabled name="price" value="<?php echo $update['price']; ?>" placeholder="基本薪资" data-bv-field="name">
              <i class="form-control-feedback" data-bv-icon-for="name" style="display: none;"></i>
            </div>
          </div> -->
          <div class="form-group has-feedback">
            <label class="col-lg-3 control-label">帐户不可提现金额</label>
            <div class="col-lg-4">
              <input type="number" step="0.01" class="form-control"  disabled name="noMoney" value="<?php echo $update['noMoney']; ?>" placeholder="帐户不可提现金额" data-bv-field="name">
              <i class="form-control-feedback" data-bv-icon-for="name" style="display: none;"></i>
            </div>
          </div>
          <div class="form-group has-feedback">
            ...
            <div class="col-lg-4">
              <input type="text" step="0.01" class="form-control" disabled  name="status" value="<?php echo $update['status'] == 0 ? "冻结" : "正常"; ?>" placeholder="商品状态" data-bv-field="name">
              <i class="form-control-feedback" data-bv-icon-for="name" style="display: none;"></i>
            </div>
          </div>
