<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:84:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\BranchStore\kucun.html";i:1568600273;s:78:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\Public\base.html";i:1563256854;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<div class="panel">
    ...
    <div class="panel-body">
        <table id="demo-dt-addrow" class="table table-striped table-bordered" cellspacing="0" width="100%">
            ...
            <tbody>
            <?php if(is_array($kucun) || $kucun instanceof \think\Collection || $kucun instanceof \think\Paginator): $i = 0; $__LIST__ = $kucun;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
            <tr>

                <td><?php echo $vo['goodsName']; ?></td>
                <td><?php echo $vo['number']; ?></td>
                <td>
                    <a href="<?php echo url('EmptyBucket/assignBucketLogs',array('user_id'=>$store_id,'name'=>$vo['goodsName'])); ?>" class="btn btn-xs btn-rounded btn-mint">查询库存记录</a>
                </td>
            </tr>
