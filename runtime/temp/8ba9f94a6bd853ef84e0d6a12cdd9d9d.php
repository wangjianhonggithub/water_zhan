<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:87:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\StoreStock\goods_add.html";i:1567045643;s:78:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\Public\base.html";i:1563256854;}*/ ?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="tab-content">
                <div id="demo-tabs-box-1" class="tab-pane fade in active">
                    <div class="form-group has-feedback">
                        ...
                        <div class="col-lg-4">
                            <input type="hidden" value="<?php echo $rs['id']; ?>"  id="goodsId">
                            <input type="hidden" value="<?php echo $rs['goods_name']; ?>"  id="goodsName">
                            <input type="text" disabled="" class="form-control" name="goodsId" placeholder="<?php echo $rs['goods_name']; ?>" data-bv-field="name">
                ...
                <div class="col-md-9">
                    <div class="checkbox">
                        <div class="col-lg-7">
                            ...
                            <li style="list-style-type:none"><input name="supplier"  value="<?php echo $vo['id']; ?>" type="radio" ><span><?php echo $vo['supplier_name']; ?></span></li>
