<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:84:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\User\Shang_update.html";i:1563256858;s:78:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\Public\base.html";i:1563256854;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  ...
  <form id="demo-bv-errorcnt" class="form-horizontal bv-form" action="" method="POST" novalidate="novalidate">
    ...
    <div class="panel-body">
      <div class="tab-content">
        ...
        <div class="form-group has-feedback">
            <label class="col-lg-3 control-label">商家二维码</label>
            <div class="col-lg-4">
              <img src="<?php echo $update['Qrcode']; ?>" alt="" style="width: 150px;height: 120px;">
            </div>
          </div>
         ...
         <div class="form-group has-feedback">
            <label class="col-lg-3 control-label">商家返现比例</label>
            <div class="col-lg-4">
              <input type="number" step="0.01" class="form-control"  name="fanxian" value="<?php echo $update['fanxian']; ?>" placeholder="商家返现比例" data-bv-field="name">
              <i class="form-control-feedback" data-bv-icon-for="name" style="display: none;"></i>
            </div>
          </div>
