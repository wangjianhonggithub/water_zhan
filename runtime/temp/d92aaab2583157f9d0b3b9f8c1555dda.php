<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:87:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\BucketCategory\index.html";i:1565243325;s:78:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\Public\base.html";i:1563256854;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<div class="panel">
    ...
    <div id="demo-custom-toolbar2" class="table-toolbar-left">
        <a href="/Admin/BucketCategory/add" id="demo-dt-addrow-btn" class="btn btn-primary"><i class="demo-pli-plus"></i> 添加</a> 
    </div>
            ...
            <tbody>
               <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                <tr class="tr">
                    ...
                    <td><input class="order" type="number" value="<?php echo $vo['order']; ?>" name="order" data-id="<?php echo $vo['id']; ?>" style="display: block;width: 80px;" /></td>
                    <td><?php echo date('Y-m-d H:i:s',$vo['createTime']); ?></td>
                    <td><?php echo date('Y-m-d H:i:s',$vo['updateTime']); ?></td>
                    <td>
                    	<a href="/Admin/Bucket_category/update?id=<?php echo $vo['id']; ?>" class="btn btn-xs btn-rounded btn-warning">修改</a>
...
<script>
    $(function(){
        $('.DeleteSubmit').click(function(){
            ...
            $.ajax({
                type: 'GET',
                url: '/Admin/BucketCategory/delete',
                data: {
                    id:id,
                },
         ...
         $('.order').blur(function(){
            ...
            $.ajax({
                type: 'GET',
                url: '/Admin/Bucket_category/order',
                data: {
                    id:id,
                    order:order,
                },
