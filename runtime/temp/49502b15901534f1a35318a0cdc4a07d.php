<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:80:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\Banner\update.html";i:1563256844;s:78:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\Public\base.html";i:1563256854;}*/ ?>
<!DOCTYPE html>
<html lang="en">
      ...
      <div class="tab-content">
        ...
        <div id="demo-tabs-box-1" class="tab-pane fade in active">
          ...
          <div class="form-group has-feedback">
            ...
            <div class="col-lg-4">
              <input type="text" class="form-control" name="banner_name" value="<?php echo $update['banner_name']; ?>" placeholder="Banner名称" data-bv-field="name">
          ...
          <div class="form-group has-feedback">
            ...
            <div class="col-lg-4">
                <img src="<?php echo $update['banner_img']; ?>" alt="" style="width:230px;height: 120px;">
            </div>
          </div>
          <div class="form-group has-feedback">
...
<script>
    $(function(){
        $('#CreateSubmit').click(function(){
          ...
          $.ajax({
            type: 'POST',
            url:'/Admin/Banner/DoUpdate?id=<?php echo $update['id']; ?>',
            data:formData,
            contentType: false,
            processData: false,
