<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:81:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\Supplier\index.html";i:1566439508;s:78:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\Public\base.html";i:1563256854;}*/ ?>
<!DOCTYPE html>
<html lang="en">
               ...
               <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                <tr>
                    ...
                    <td>
                        ...
                        <a href="/Admin/Supplier/giveLogs?id=<?php echo $vo['id']; ?>&supplier_name=<?php echo $vo['supplier_name']; ?>"  data-id="<?php echo $vo['id']; ?>" class="btn btn-xs btn-rounded btn-warning">查看供货记录</a>
