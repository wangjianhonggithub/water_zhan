<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:77:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\Banner\add.html";i:1563256844;s:78:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\Public\base.html";i:1563256854;}*/ ?>
<!DOCTYPE html>
<html lang="en">
      ...
      <div class="tab-content">
        ...
        <div id="demo-tabs-box-1" class="tab-pane fade in active">
          ...
          <div class="form-group has-feedback">
            ...
            <div class="col-lg-4">
              <input type="text" class="form-control" name="banner_name" placeholder="Banner名称" data-bv-field="name">
          ...
          <div class="form-group has-feedback">
            ...
            <div class="col-lg-4">
              <input type="file" class="form-control" name="banner_img" placeholder="轮播图片" data-bv-field="name">
              <i class="form-control-feedback" data-bv-icon-for="name" style="display: none;"></i>
            </div>
          </div>
        </div>
