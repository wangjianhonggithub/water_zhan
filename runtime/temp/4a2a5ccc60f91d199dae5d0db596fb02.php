<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:88:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\Statistics\day_zhichu.html";i:1568886686;s:78:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\Public\base.html";i:1563256854;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<div class="panel">
    <div class="panel-heading">
        <h3 class="panel-title">成本支出-日统计</h3>
    </div>

    <div id="demo-custom-toolbar2" class="table-toolbar-left" style="width:500px;margin-left: 25px">
        <a href="/Admin/Statistics/expenditure?type=1" class="btn btn-xs btn-rounded btn-success">日统计</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <a href="/Admin/Statistics/expenditure?type=2" class="btn btn-xs btn-rounded btn-success">月统计</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <a href="/Admin/Statistics/expenditure?type=3" class="btn btn-xs btn-rounded btn-success">年统计</a>
    ...
    <div class="panel-body">
        <table id="demo-dt-addrow" class="table table-striped table-bordered" cellspacing="0" width="100%">
            ...
            <tr>
                ...
                <th style="text-align: center">配送员工资</th>
                <th style="text-align: center">商品成本</th>
                <th style="text-align: center">店长工资</th>
                <th style="text-align: center">杂项</th>
            ...
            <tr>
                <td style="text-align: center"><?php echo $vo['rent_cost']; ?></td>
                <td style="text-align: center"><?php echo $vo['song_salary']; ?></td>
                <td style="text-align: center"><?php echo $vo['commodity_cost']; ?></td>
                <td style="text-align: center"><?php echo $vo['admin_salary']; ?></td>
                <td style="text-align: center"><?php echo $vo['electricity_fees']+$vo['charge_for_water']; ?></td>
