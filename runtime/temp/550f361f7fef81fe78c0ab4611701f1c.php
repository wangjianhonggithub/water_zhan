<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:78:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\User\profit.html";i:1563256854;s:78:"E:\PHPTutorial\WWW\jjzs\jjzs\public/../application/admin\view\Public\base.html";i:1563256854;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="panel-body">
        <table id="demo-dt-addrow" class="table table-striped table-bordered" cellspacing="0" width="100%">
            <thead>
                <tr>
                    <th>ID</th>
                    <th class="min-tablet">商家昵称</th>
                    <th class="min-tablet">店铺名称</th>
                    <th class="min-tablet">手机号码</th>
                    <th class="min-tablet">日期</th>
                    <th class="min-tablet">收益</th>
                </tr>
            </thead>
            <tbody>
