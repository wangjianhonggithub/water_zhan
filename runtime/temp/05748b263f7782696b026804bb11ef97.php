<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:75:"E:\PHPTutorial\WWW\jjzs\jjzs/application/admin\view\BranchStore\profit.html";i:1566974759;s:68:"E:\PHPTutorial\WWW\jjzs\jjzs/application/admin\view\Public\base.html";i:1563256854;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<div class="panel">
    <div class="panel-heading">
        <h3 class="panel-title">分店日支出收益统计</h3>
    </div>

    <div id="demo-custom-toolbar2" class="table-toolbar-left" style="width:500px">
        <form action="/Admin/Branch_store/profit" type="get">
            ...
            <tbody>
               <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                <tr>
                    ...
                    <?php endif; ?>
                    <td><?php echo $vo['profit']['cangchu']; ?></td>
                    <td><?php echo $vo['profit']['goods_diff']; ?></td>
                    <td><?php echo $vo['profit']['yunfei']; ?></td>
                    <td><?php echo $vo['profit']['rent_income']; ?></td>
                    <td><?php echo $vo['net_profit']; ?></td>
                    <td><?php echo $vo['expenditure']['commodity_cost']; ?></td>
                    <td><?php echo $vo['expenditure']['rent_cost']; ?></td>
                    <td><?php echo $vo['expenditure']['admin_salary']; ?></td>
                    <td><?php echo $vo['expenditure']['song_salary']; ?></td>
                    <td><?php echo $vo['expenditure']['electricity_fees']+$vo['expenditure']['charge_for_water']; ?></td>
                    <td><?php echo date("Y-m-d",$vo['statistical_time']); ?></td>
                </tr>
